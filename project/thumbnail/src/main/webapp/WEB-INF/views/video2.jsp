...
<body>
		...
		<div class="row">
			<div class="col-md-6 left">
				<div class="upper-left" id="video">
					<iframe class="videoplayer" id="vp"
						src=""
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			//video player
			var videoUrl="http://www.youtube.com/embed/"+videoId+"?&rel=0&autohide=1&autoplay=1&start=0";
			...
			//wordCloud
			$.ajax({
				url : "/data/keywords/" + queryString["videoId"] + ".json",
				success : function(data) {
